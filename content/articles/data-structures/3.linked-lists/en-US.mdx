...
>
  Before: <span className="text-danger">42 → 17</span> &nbsp;→&nbsp; After: <span className="text-success">99 → 42 → 17</span>
</MemoryVisualization>
...
>
  Before: <span className="text-danger">42 → 17 → 8</span> &nbsp;→&nbsp; After: <span className="text-success">42 → 8</span>
</MemoryVisualization>
