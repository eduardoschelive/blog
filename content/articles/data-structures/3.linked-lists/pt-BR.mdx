...
slug: linked-lists
coverImage: linked-lists-cover.svg
thumbnail: linked-lists-thumbnail.svg
keywords:
  [
    linked lists,
    data structures,
...
>
  Antes: <span className="text-danger">42 → 17</span> &nbsp;→&nbsp; Depois: <span className="text-success">99 → 42 → 17</span>
</MemoryVisualization>
...
>
  Antes: <span className="text-danger">42 → 17 → 8</span> &nbsp;→&nbsp; Depois: <span className="text-success">42 → 8</span>
</MemoryVisualization>
