...
slug: stack
coverImage: stack-cover.svg
thumbnail: stack-thumbnail.svg
keywords:
  [
    stack,
    LIFO,
...
<StackVisualization title="push(99) on [3, 8, 17, 42]:" items={[3, 8, 17, 42]} incoming={99}>
...
<StackVisualization title="pop() from [3, 8, 17, 42, 99]:" items={[3, 8, 17, 42, 99]} outgoing>
...
<Callout type="info">
This is the same pattern described in the [Linked Lists article](/categories/data-structures/articles/linked-lists): insert and delete at the head are O(1). A stack is just a linked list with a restricted interface — only the head is ever touched.
</Callout>
