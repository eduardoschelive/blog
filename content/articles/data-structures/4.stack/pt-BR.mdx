...
<StackVisualization title="push(99) em [3, 8, 17, 42]:" items={[3, 8, 17, 42]} incoming={99}>
...
<StackVisualization title="pop() de [3, 8, 17, 42, 99]:" items={[3, 8, 17, 42, 99]} outgoing>
...
<Callout type="info">
Esse é o mesmo padrão descrito no [artigo sobre Linked Lists](/categorias/estruturas-de-dados/artigos/linked-lists): insertion e deletion na head são O(1). Uma stack é apenas uma linked list com interface restrita — somente a head é tocada.
</Callout>
