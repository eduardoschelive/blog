...
function generatePathnames() {
  ...
  for (const categorySlug of categories) {
    ...
    if (LANGUAGES.every((lang) => categoryPaths[lang])) {
      // Usar o idioma primário como chave, mas só incluir outros idiomas no objeto
...
function main() {
  console.log('🚀 Generating pathnames...')
...
`
  ...
  console.log('✅ Pathnames generated at: ' + outputPath)
